    ...
    <AnimatePresence>
      {isOpen && (
          ...
          <motion.div
            ...
            className="relative w-full max-w-[1100px] max-h-[calc(100vh-2rem)] md:max-h-[calc(100vh-3rem)] bg-surface-primary border border-border rounded-xl shadow-2xl overflow-hidden flex flex-col"
