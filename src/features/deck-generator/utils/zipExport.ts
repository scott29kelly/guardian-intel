...
## Slides
${deck.slides.map((slide, i) => `${i + 1}. ${slide.sectionId} (${slide.type})${slide.imageData ? ' - 🍌 Nano Banana Pro' : slide.aiGenerated ? ' - AI Generated' : ''}`).join('\n')}
